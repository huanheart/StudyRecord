...
void CurrentListControlWidget::ChangeInformation(long long CurrentNum,LabelInformation Information)
{
...
void CurrentListControlWidget::SaveMyInformation(LabelInformation Information, Whether_to_send decide)
{

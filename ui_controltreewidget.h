...
"}"));
    ...
    void retranslateUi(QWidget *controltreewidget)
    {
        ...
        ___qtreewidgetitem5->setText(0, QApplication::translate("controltreewidget", "\350\213\261\350\257\255\345\215\225\350\257\215", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem6 = treeWidget->topLevelItem(5);
        ___qtreewidgetitem6->setText(0, QApplication::translate("controltreewidget", "6", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem7 = treeWidget->topLevelItem(6);
        ___qtreewidgetitem7->setText(0, QApplication::translate("controltreewidget", "7", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem8 = treeWidget->topLevelItem(7);
        ___qtreewidgetitem8->setText(0, QApplication::translate("controltreewidget", "8", Q_NULLPTR));

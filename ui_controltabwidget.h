...
"}"));
        ...
        pushButton->setGeometry(QRect(350, 180, 80, 24));
...
"}"));
        ...
        label_2->setGeometry(QRect(250, 140, 54, 16));
    ...
    void retranslateUi(QWidget *controltabwidget)
    {
        ...
        pushButton->setText(QApplication::translate("controltabwidget", "\346\226\260\344\271\237", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("controltabwidget", "\351\241\265", Q_NULLPTR));
        label_2->setText(QApplication::translate("controltabwidget", "\346\212\245\351\224\231", Q_NULLPTR));
